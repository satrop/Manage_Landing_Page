...
import './nav.scss';
import MenuBurger from '../../assets/img/icon-hamburger.svg';
...
const Nav = () => {
	...
	return (
		<div className="container">
			<div className={`fade ${isActive ? 'active' : null}`}></div>
			<nav>
				<a
					className="main-logo"
					href="#nogo"
					aria-label="Manage logo linking back to home page."
				>
				...
				>
					<li>
						<a href="#nogo">Pricing</a>
					</li>
					<li>
						<a href="#nogo">Product</a>
					</li>
					<li>
						<a href="#nogo">About Us</a>
					</li>
					<li>
						<a href="#nogo">Careers</a>
					</li>
					<li>
						<a href="#nogo">Community</a>
					</li>
				</ul>
				...
				<button
					className={`menu-trigger ${isActive ? 'active' : null}`}
